...
<body>
    <a href="mailto:kevinandreslopez104@gmail.com" target="_blank" class="btn-flotante" id="btnCarrito">Carrito <span class="badge bg-success" id="carrito">0</span></a>
  
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="admin/index.php">M&M</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <?php } ?>
                        <a href="mailto:kevinandreslopez104@gmail.com" class="nav-link text-secondary" category="all">Contacto</a>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">M&M - Marta & Maria </h1>
                <p class="lead fw-normal text-white-50 mb-0">Las mejores en Dulceria</p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Kevin Lopez 2023</p>
        </div>
    </footer>
